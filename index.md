...
totalWithdrawal | String | Total withdrawal amount, expressed in USDT.<br>The conversion to USDT is based on the last spot price of the withdrawn currency pair at the moment the deposit is credited.
...
equity | String | The equity of Futures account in USDT
totalEquity | String | The total equity of all account in USDT
